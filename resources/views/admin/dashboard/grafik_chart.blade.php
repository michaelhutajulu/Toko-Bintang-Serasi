                ...
                <div class="card-body">
                    <div class="tab-content p-0">
                        ...
                        <div class="chart tab-pane active" id="revenue-chart"
                            ...
                            <canvas id="revenue-chart-canvas" height="539"
                                style="height: 300px; display: block; width: 901px;" width="1621"
                ...
                <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg">
                            ...
                            <div class="direct-chat-text">
                                Working with Admin on a great new app! Wanna join?
                            </div>
            ...
            <div class="card bg-gradient-primary">
                ...
                <div class="card-body">
                    <div id="world-map"
                        ...
                        <svg width="651.233" height="250">
                            <g transform="scale(0.42158516020236086) translate(292.86233799999997, 0)">
                                <path
                ...
                <div class="card-footer bg-transparent">
                    <div class="row">
                        <div class="col-4 text-center">
                            <div id="sparkline-1"><canvas width="143" height="89"
                                    style="width: 80px; height: 50px;"></canvas></div>
                            <div class="text-white">Visitors</div>
                        </div>

                        <div class="col-4 text-center">
                            <div id="sparkline-2"><canvas width="143" height="89"
                                    style="width: 80px; height: 50px;"></canvas></div>
                            <div class="text-white">Online</div>
                        </div>

                        <div class="col-4 text-center">
                            <div id="sparkline-3"><canvas width="143" height="89"
                                    style="width: 80px; height: 50px;"></canvas></div>
            ...
            <div class="card bg-gradient-info">
                ...
                <div class="card-body">
                    ...
                    <canvas class="chart chartjs-render-monitor" id="line-chart"
                        style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 901px;"
                        width="1621" height="449"></canvas>
                </div>

                <div class="card-footer bg-transparent">
                    <div class="row">
                        <div class="col-4 text-center">
                            <div style="display:inline;width:60px;height:60px;"><canvas width="107" height="107"
                                    ...
                                    <div class="datepicker">
                                        <div class="datepicker-days" style="">
                                            <table class="table table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="picker-switch" data-action="pickerSwitch"
                                                            colspan="5" title="Select Month">March 2024</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="02/25/2024"
                                                            class="day old weekend">25</td>
                                                        <td data-action="selectDay" data-day="02/26/2024"
                                                            class="day old">26</td>
                                                        <td data-action="selectDay" data-day="02/27/2024"
                                                            class="day old">27</td>
                                                        <td data-action="selectDay" data-day="02/28/2024"
                                                            class="day old">28</td>
                                                        <td data-action="selectDay" data-day="02/29/2024"
                                                            class="day old">29</td>
                                                        <td data-action="selectDay" data-day="03/01/2024"
                                                            class="day">
                                                            1</td>
                                                        <td data-action="selectDay" data-day="03/02/2024"
                                                            class="day weekend">2</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/03/2024"
                                                            class="day weekend">3</td>
                                                        <td data-action="selectDay" data-day="03/04/2024"
                                                            class="day">
                                                            4</td>
                                                        <td data-action="selectDay" data-day="03/05/2024"
                                                            class="day">
                                                            5</td>
                                                        <td data-action="selectDay" data-day="03/06/2024"
                                                            class="day">
                                                            6</td>
                                                        <td data-action="selectDay" data-day="03/07/2024"
                                                            class="day">
                                                            7</td>
                                                        <td data-action="selectDay" data-day="03/08/2024"
                                                            class="day">
                                                            8</td>
                                                        <td data-action="selectDay" data-day="03/09/2024"
                                                            class="day weekend">9</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/10/2024"
                                                            class="day weekend">10</td>
                                                        <td data-action="selectDay" data-day="03/11/2024"
                                                            class="day">
                                                            11</td>
                                                        <td data-action="selectDay" data-day="03/12/2024"
                                                            class="day">
                                                            12</td>
                                                        <td data-action="selectDay" data-day="03/13/2024"
                                                            class="day">
                                                            13</td>
                                                        <td data-action="selectDay" data-day="03/14/2024"
                                                            class="day">
                                                            14</td>
                                                        <td data-action="selectDay" data-day="03/15/2024"
                                                            class="day">
                                                            15</td>
                                                        <td data-action="selectDay" data-day="03/16/2024"
                                                            class="day weekend">16</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/17/2024"
                                                            class="day weekend">17</td>
                                                        <td data-action="selectDay" data-day="03/18/2024"
                                                            class="day">
                                                            18</td>
                                                        <td data-action="selectDay" data-day="03/19/2024"
                                                            class="day">
                                                            19</td>
                                                        <td data-action="selectDay" data-day="03/20/2024"
                                                            class="day">
                                                            20</td>
                                                        <td data-action="selectDay" data-day="03/21/2024"
                                                            class="day">
                                                            21</td>
                                                        <td data-action="selectDay" data-day="03/22/2024"
                                                            class="day">
                                                            22</td>
                                                        <td data-action="selectDay" data-day="03/23/2024"
                                                            class="day weekend">23</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/24/2024"
                                                            class="day weekend">24</td>
                                                        <td data-action="selectDay" data-day="03/25/2024"
                                                            class="day">
                                                            25</td>
                                                        <td data-action="selectDay" data-day="03/26/2024"
                                                            class="day">26</td>
                                                        <td data-action="selectDay" data-day="03/27/2024"
                                                            class="day">27</td>
                                                        <td data-action="selectDay" data-day="03/28/2024"
                                                            class="day">28</td>
                                                        <td data-action="selectDay" data-day="03/29/2024"
                                                            class="day">29</td>
                                                        <td data-action="selectDay" data-day="03/30/2024"
