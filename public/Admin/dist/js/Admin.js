...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Admin = {}, global.jQuery));
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config) {
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('Admin:IFrame:Options', JSON.stringify(_options));
        ...
        new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('Admin:IFrame:Options')))._initFrameElement();
      }
    };
