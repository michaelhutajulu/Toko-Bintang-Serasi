...
> ##### Reminder!
> Admin uses all of Bootstrap 4 components. It's a good start to review the [Bootstrap documentation](https://getbootstrap.com/) to get an idea of the various components that this documentation __does not__ cover.
{: .quote-orange .mt-0}
...
Top navbar example can be found in this [demo page](https://Admin.io/themes/dev/Admin/pages/layout/top-nav.html). 


<nav class="navbar navbar-expand navbar-light navbar-white">
  <div class="container">
    <a href="index3.html" class="navbar-brand">
      <img src="{{ '/assets/img/logoo.jpeg' | prepend: site.baseurl }}" alt="Admin Logo" class="brand-image img-circle elevation-3"
...
<nav class="main-header navbar navbar-expand navbar-light navbar-white">
  <div class="container">
    <a href="index3.html" class="navbar-brand">
      <img src="dist/img/logoo.jpeg" alt="Admin Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin 3</span>
    </a>
    <!-- Left navbar links -->
