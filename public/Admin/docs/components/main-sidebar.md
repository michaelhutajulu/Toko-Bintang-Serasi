...
<a href="#" class="brand-link logo-switch">
  <img src="dist/img/logo-xs.png" alt="Admin Docs Logo Small" class="brand-image-xl logo-xs">
  <img src="dist/img/logo-xl.png" alt="Admin Docs Logo Large" class="brand-image-xs logo-xl" style="left: 12px">
</a>
```
