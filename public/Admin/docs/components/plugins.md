...
title: Plugins
---
Admin comes with color overrides & extras for the following plugins.
...
If you use SweetAlert and load the SweetAlert CSS before Admin's CSS, then the colors of any icon changes to Admin's default colors.


### Toastr

If you use Toastr and load the Toastr CSS before Admin's CSS, then the background colors changes to Admin's default colors.
