...
> ##### Tip!
> The [starter page](https://Admin.io/themes/v3/starter.html) is a good place to start building your app if you'd like to start from scratch.
{: .quote-info .mt-0}
...
Admin 3.2 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
Preloader to avoid [https://github.com/ColorlibHQ/Admin/discussions/3319](https://github.com/ColorlibHQ/Admin/discussions/3319)

```html
<div class="wrapper">
  <!-- Preloader -->
  <div class="preloader">
    <img src="dist/img/logoo.jpeg" alt="AdminLogo" height="60" width="60">
  </div>
</div>
```
...
Admin 3.2 provides a dark mode option. You can add in body tag:
...
Admin 3.2 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
...
> ###### New
> You can use override the link/accent color in Admin, you can add `.accent-*` to `body`.
{: .quote-info}
