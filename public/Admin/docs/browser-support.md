...
Admin comes with the same browser support as Bootstrap 4.
...
You can find our supported range of browsers and their versions in [our .browserslistrc file](https://github.com/ColorlibHQ/Admin/blob/master/.browserslistrc):
