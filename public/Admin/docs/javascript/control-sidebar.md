...
The control sidebar component is part of Admin's layout as the right sidebar. 
...
###### jQuery
{: .text-bold }
Just like all other Admin plugins, you can also activate the toggle button using jQuery by running the following example. 
```js
